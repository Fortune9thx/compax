      ...
      <div className="grid gap-6 max-w-2xl">
        ...
        <Card>
          ...
          <p className="text-xs text-text-secondary leading-relaxed mt-3">
            ...
            overdue escrows and markets, or <code className="compax-mono text-text-primary">resolve_movement()</code> on
            a challenged vault capital movement, and can claim reputation on behalf of a party. It never moves
            funds - it can only ask a contract to reason. Run it with{" "}
            <code className="compax-mono text-text-primary">npm run keeper</code> from a machine holding a
            registered keeper key. This is the recommended way to trigger resolution on overdue instruments, since
            no contract here has a verified onchain way to check whether a deadline has actually passed - see{" "}
            <code className="compax-mono text-text-primary">keeper/cycle.mjs</code>.
          </p>
          {connected && (
          ...
          <p className="text-[11px] text-text-muted leading-relaxed mt-3">
            ...
            your choice) to see the last resolve cycle it ran.
          </p>
        </Card>
      </div>
    </AppShell>
